...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0F2027,50:203A43,100:2C5364&height=280&section=header&text=Monish%20Sakpal&fontSize=50&fontColor=ffffff&animation=fadeIn&fontAlignY=32&desc=Senior%20Data%20Analyst%20|%20BI%20Specialist%20|%20AI%2FML%20Engineer&descAlignY=55&descSize=17"/>
...
- 🗄️ Design SQL Reporting Systems
- 🐍 Automate Workflows using Python
- 🤖 Build Machine Learning Models
- 💬 Develop Generative AI & RAG Applications
...
|------------|------------|----------------|
| 📊 Insurance Claims Analytics | Power BI • SQL | Claims & KPI Dashboard |
| 🤖 Insurance Fraud Detection | Python • ML | Fraud & Risk Analytics |
| 📉 Customer Churn Prediction | Python • SQL | Customer Retention |
| 🏦 Banking MIS Dashboard | SQL • Power BI | Executive Reporting |
| 📈 Stock Market Analytics | Python • Power BI | Investment Analytics |
| 💬 Sentiment Analysis | NLP | Customer Insights |
| 👁️ Object Detection | YOLO | Computer Vision |
| 🤖 RAG AI Assistant | LangChain • OpenAI | Enterprise Knowledge Assistant |
